...
# rubocop-ruby2_0 Rakefile v7.1.20 - 2026-09-07
...
# rake install                                # Build and install rubocop-ruby2_0-1.0.0.gem in...
# rake install:local                          # Build and install rubocop-ruby2_0-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template rubocop-ruby2_0 against itse...
