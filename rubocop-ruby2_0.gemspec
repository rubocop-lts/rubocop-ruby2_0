...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/ruby2_0/version.rb", mod) }::Rubocop::Ruby20::Version::VERSION
  ...
  spec.homepage = "https://github.com/rubocop-lts/rubocop-ruby2_0"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-ruby2-0.galtzo.com"
  ...
  # The 'git' gem is optional; rubocop-ruby2_0 falls back to shelling out to `git` if it is not present.
